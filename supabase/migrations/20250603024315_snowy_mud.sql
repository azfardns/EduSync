/*
  # Secure Student Enrollment Schema

  1. Updates to profiles table
    - Add full_name field (single field as required)
    - Add faculty and program references
    - Add year of study and enrollment status
    - Remove unnecessary name splitting fields

  2. New Tables
    - faculties
    - programs (linked to faculties)
    - student_courses (join table for course selections)

  3. Security
    - Enable RLS on all tables
    - Strict policies for immutable enrollment data
*/
